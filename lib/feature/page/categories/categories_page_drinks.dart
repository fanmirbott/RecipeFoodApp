...
class CategoriesPageDrinks extends StatefulWidget {
  const CategoriesPageDrinks({
    super.key,
    required this.items,
    required this.text,
    required this.text1,
  ...
  @override
  State<CategoriesPageDrinks> createState() => _CategoriesPageDrinksState();
}

class _CategoriesPageDrinksState extends State<CategoriesPageDrinks> {
