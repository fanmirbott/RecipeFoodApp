...
class CategoriesPageDinner extends StatefulWidget {
  const CategoriesPageDinner({
    super.key,
    required this.items,
    required this.text,
    required this.text1,
  ...
  @override
  State<CategoriesPageDinner> createState() => _CategoriesPageDinnerState();
}

class _CategoriesPageDinnerState extends State<CategoriesPageDinner> {
