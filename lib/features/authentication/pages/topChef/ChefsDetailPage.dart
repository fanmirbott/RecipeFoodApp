...
import 'package:recipefoodapp/features/authentication/pages/topChef/chef_recipe_grid_view.dart';
...
class ChefsDetailPage extends StatefulWidget {
  const ChefsDetailPage({super.key, required this.id});
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ChefDetailViewModel(
        ChefDetailRepository(client: ApiClient()),
        widget.id,
      ),
      builder: (context, child) => Consumer<ChefDetailViewModel>(
